...
import ph.edu.dlsu.mobdeve.cervales.santiago.paresell.databinding.ActivityProfileBinding
...
//                println("IT "+ it.value)
                binding.accountName.text = it.child("firstName").value.toString() + " " + it.child("lastName").value.toString()
                binding.accountLocation.text = it.child("city").value.toString() + " City"
